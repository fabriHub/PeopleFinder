...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-registrazione100">
						
				<form class="login100-form validate-form" method="POST" action="registrati">
					...
					<div class="wrap-input100 validate-input" data-validate = "Ripeti la password">
						<input class="input100" type="password" name="password2" placeholder="Conferma password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
