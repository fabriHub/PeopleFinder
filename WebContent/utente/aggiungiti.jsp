			...
			<div class="container" id="contenitore">
				...
				<div class="containerTabella">
					...
					<div class="body">
						...
						<%
							List<String[]> gruppi = (List<String[]>) request.getAttribute("aggiungiti");
							gruppi.toString();
						...
						%>	
							<div class="tabellaRighe4Col riga">
								...
								<div class="col4">
									<button type = "button" style="width: 80%; height: 3vw;" value = "Iscriviti" onclick="location.href='./aggiungiIscrizioneGruppo?idGruppo=<% out.print(gruppo[0]); %>'">Iscriviti</button>
								</div>
							</div>
						<%		
							}
